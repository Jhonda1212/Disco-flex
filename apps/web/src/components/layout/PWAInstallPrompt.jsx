      ...
      <div className="w-full max-w-sm bg-zinc-900 border border-zinc-700/60 rounded-2xl p-6 shadow-2xl">
        ...
        {isIos ? (
            ...
            <ol className="space-y-2 text-sm text-zinc-300">
              <li className="flex items-start gap-2">
                ...
                <span>
                  ...
                  <span className="inline-block align-middle text-gold-400">
                    ⬆
                  </span>{' '}
                  en Safari
                </span>
              ...
              <li className="flex items-start gap-2">
                ...
                <span>
                  Pulsa{' '}
                  <strong className="text-zinc-100">Agregar</strong> en la
                  esquina superior
                </span>
              </li>
            </ol>
          ...
          <p className="text-zinc-400 text-sm mb-5">
            Añade Flex a tu pantalla de inicio para una experiencia más rápida,
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className={`${isIos ? 'flex-1' : ''
              } py-2.5 px-4 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 text-sm rounded-xl transition-colors`}
          >
